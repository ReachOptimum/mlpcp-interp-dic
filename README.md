...
#### 3.6. Convert shear strain values from tensorial ($\epsilon_{xy}$) to engineering ($\gamma_{xy}$) convention with [dic_epsilon_to_gamma.py](/src/dic_epsilon_to_gamma_xy.py)
