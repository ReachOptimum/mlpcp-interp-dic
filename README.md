...
This work is forked from [mlpcp-interp](https://github.com/dmitreiro/mlpcp-interp). The previous study was performed on numerical data. For this work, DIC-levelled data is used to confirm the practical applicability of the proposed interpolation approach.
